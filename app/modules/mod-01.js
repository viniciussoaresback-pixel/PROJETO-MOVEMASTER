...
function normalizarPedido(p) {
    ...
    cteSituacao: p.cte_situacao || 'emitido',
    cteCanceladoEm: p.cte_cancelado_em || null,
    cteCanceladoPor: p.cte_cancelado_por || null,
    cteCanceladoMotivo: p.cte_cancelado_motivo || null,
    cteSubstitui: p.cte_substitui || null,
    cteSubstituidoPor: p.cte_substituido_por || null,
    cceNumero: p.cce_numero || null,
    cceData: p.cce_data || null,
    cceDescricao: p.cce_descricao || null,
